...
BEGIN_RCPP
    ...
    __result = Rcpp::wrap(KMUP(X, b, d, xx, e, L, Ve, pi));
    return __result;
END_RCPP
}
// KMUP2
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< double >::type Ve(VeSEXP);
    Rcpp::traits::input_parameter< double >::type pi(piSEXP);
    __result = Rcpp::wrap(KMUP2(X, Use, b, d, xx, E, L, Ve, pi));
    return __result;
END_RCPP
}
// emBA
...
BEGIN_RCPP
    ...
    __result = Rcpp::wrap(emBA(y, gen, df, R2));
    return __result;
END_RCPP
}
// emBB
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< double >::type R2(R2SEXP);
    Rcpp::traits::input_parameter< double >::type Pi(PiSEXP);
    __result = Rcpp::wrap(emBB(y, gen, df, R2, Pi));
    return __result;
END_RCPP
}
// emBC
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< double >::type R2(R2SEXP);
    Rcpp::traits::input_parameter< double >::type Pi(PiSEXP);
    __result = Rcpp::wrap(emBC(y, gen, df, R2, Pi));
    return __result;
END_RCPP
}
// emRR
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< double >::type df(dfSEXP);
    Rcpp::traits::input_parameter< double >::type R2(R2SEXP);
    __result = Rcpp::wrap(emRR(y, gen, df, R2));
    return __result;
END_RCPP
}
// emBL
...
BEGIN_RCPP
    ...
    __result = Rcpp::wrap(emBL(y, gen, R2, alpha));
    return __result;
END_RCPP
}
// emDE
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< NumericMatrix >::type gen(genSEXP);
    Rcpp::traits::input_parameter< double >::type R2(R2SEXP);
    __result = Rcpp::wrap(emDE(y, gen, R2));
    return __result;
END_RCPP
}
// emEN
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< double >::type R2(R2SEXP);
    Rcpp::traits::input_parameter< double >::type alpha(alphaSEXP);
    __result = Rcpp::wrap(emEN(y, gen, R2, alpha));
    return __result;
END_RCPP
}
// BayesB
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< double >::type df(dfSEXP);
    Rcpp::traits::input_parameter< double >::type R2(R2SEXP);
    __result = Rcpp::wrap(BayesB(y, X, it, bi, pi, df, R2));
    return __result;
END_RCPP
}
